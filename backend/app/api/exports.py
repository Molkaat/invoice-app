...
async def export_to_quickbooks(
    ...
    webhook_url: str = Query("https://webhook.site/3add8626-bfb3-4208-8b91-6646f30f755c", description="QuickBooks webhook URL"),
    invoice_data: dict = None,  # Add this parameter
    db: Session = Depends(get_db)
):
    """Export invoices to QuickBooks via direct webhook"""
    
    try:
        # Try to get invoices from request body first, then from database
...
# Add this new endpoint to your exports.py file
...
async def export_to_xero(
    background_tasks: BackgroundTasks,
    webhook_url: str = Query("https://webhook.site/3add8626-bfb3-4208-8b91-6646f30f755c", description="Xero webhook URL"),
    db: Session = Depends(get_db)
):
